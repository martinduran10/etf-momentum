...
# Snapshot of the Phase 1 headline metrics frozen at the moment Phase 2 was
# layered on; any drift here means the overlay (or some other change) has
# perturbed Phase 1, which must not happen.
PHASE1_FROZEN = {
